...
for key in list(config_serviceapp.exteplayer3.keys()):
	...
	config_serviceapp.exteplayer3[key].dts_transcoding = ConfigSelection(default="passthrough", choices=[("passthrough", _("Passthrough")), ("ac3", _("Dolby Digital"))])
	config_serviceapp.exteplayer3[key].truehd_transcoding = ConfigSelection(default="passthrough", choices=[("passthrough", _("Passthrough")), ("ac3", _("Dolby Digital"))])
